...
from app.routes import catalog, load_data, auth, admin, images, load_files, export_data
...
def register_blueprints(app):
    ...
    app.register_blueprint(export_data.export_data_bp)

def set_CORS(app):
    # Set CORS allowed domains
    CORS(app, origins=['https://tiendafleming.com', 'https://www.tiendafleming.com'])
